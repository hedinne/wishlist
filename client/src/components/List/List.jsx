            ...
            {open &&
              ...
              >
                ...
                >
                  <path
                    fill="#ddd"
                    d="M10 1h4q1.242 0 2.121 0.879t0.879 2.121v1h4q0.414 0 0.707 0.293t0.293 0.707-0.293 0.707-0.707 0.293h-1v12q0 1.242-0.879 2.121t-2.121 0.879h-10q-1.242 0-2.121-0.879t-0.879-2.121v-12h-1q-0.414 0-0.707-0.293t-0.293-0.707 0.293-0.707 0.707-0.293h4v-1q0-1.242 0.879-2.121t2.121-0.879zM18 19v-12h-12v12q0 0.414 0.293 0.707t0.707 0.293h10q0.414 0 0.707-0.293t0.293-0.707zM14 3h-4q-0.414 0-0.707 0.293t-0.293 0.707v1h6v-1q0-0.414-0.293-0.707t-0.707-0.293z"
                  />
                </svg>
              </button>}
        ...
        {this.state.copyOpen &&
          <div className={s.clipboardContainer}>
            <input
              ...
              readOnly
              value={url}
              onFocus={this.clipboardFocus}
              className={s.clipboardInput}
            />
                ...
                <li key={item._id} className={s.li}>
                  ...
                  <MediaQuery query="(max-width: 768px)">
                    {openItem.owner === list._id &&
                      !isNew &&
                      item._id === openItem._id &&
                      <Details openItem={openItem} onRemoveItem={onRemoveItem} />}
                  </MediaQuery>
                </li>
              ))}
          </ul>
